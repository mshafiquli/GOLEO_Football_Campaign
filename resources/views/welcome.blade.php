...
<body>
    ...
    <div class="modal fade" id="voteModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content vote-modal">
                <div class="vote-modal-header" id="voteModalHeader">
                ...
                <div class="vote-modal-body">
                    <div class="switch-tabs" id="switchTab">
    ...
    <div class="modal fade" id="successModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="overflow-hidden modal-content success-modal rounded-4">
                <div class="text-center success-header position-relative" id="successHeader">
                ...
                <div class="px-4 text-center modal-body">
                    ...
                    <button class="mb-3 btn copy-btn w-100" id="copyLinkBtn">
    ...
    <script>
        ...
        hilalBtn.addEventListener('click', () => {
            ...
            voteModalHeader.className = 'vote-modal-header';
            switchTab.className = 'switch-tabs';
        });

        ittihadBtn.addEventListener('click', () => {
            submitBtn.className = 'submit-btn2'; // class for Ittihad
            voteModalHeader.className = 'vote-modal-header2';
            switchTab.className = 'switch-tabs2';
        });
        ...
        document.getElementById('copyLinkBtn').addEventListener('click', function() {
            ...
            navigator.clipboard.writeText(currentUrl) // copy to clipboard
                .then(() => {
                    alert('تم نسخ الرابط إلى الحافظة!'); // success message
                })
                .catch(err => {
